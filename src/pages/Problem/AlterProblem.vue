...
export default {
  ...
  methods: {
    ...
    //   console.log(this.problem.judgeData)
      ...
      request({
        url: "/problem/alter" + this.$route.params.id,
        method: "POST",
        data: this.problem
      })
        .then(res => {
  ...
  mounted() {
    ...
    request({
      ...
      .then(res => {
        ...
        this.judgeData = JSON.parse(res.data.extend.problem.judgeData)
        this.title = this.problem.title
        this.timeLimit = this.problem.timeLimit
        this.memoryLimit = this.problem.memoryLimit
        // console.log(this.problem);
      })
      .catch(err => {
        console.log(err);
