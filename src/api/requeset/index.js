...
export function updateUserAvatar(data) {
    return request({
        headers: {"Content-Type": "multipart/form-data"}, //进行图片的上传，一定要注意headers的设置：
...
/**
 * judge user password by userId
 * @param {Object} user
 */
export function judgeUserPassword(user) {
    return request({
 ...
 * @param {object} params
 */
export function getAdminUserSet(pageNumber, params) {
    return request({
 ...
 * @param{int} sid
 */
export function delSolutionById(sid) {
    return request({
        url: "admin/solution/" + sid,
        method: "DELETE"
    })
}
